...
@AutoValue
public abstract class BindiegoJavascriptTextTransformer {
  ...
  public interface JavascriptTextTransformerOptions extends PipelineOptions {
    ...
    @Description("String parameter passed in for JavaScript function")
    ValueProvider<String> getJavascriptTextTransformParameter();

    void setJavascriptTextTransformParameter(
        ValueProvider<String> javascriptTextTransformParameter);
  }
  ...
  public abstract static class JavascriptRuntime {
    ...
    /** Builder for {@link BindiegoJavascriptTextTransformer}. */
    @AutoValue.Builder
    public abstract static class Builder {
      ...
      public abstract Builder setParameter(@Nullable String parameter);

      public abstract JavascriptRuntime build();
    }

    /**
     * Factory method for generating a BindiegoJavascriptTextTransformer.Builder.
     *
     * @return a BindiegoJavascriptTextTransformer builder
     */
    public static Builder newBuilder() {
      return new AutoValue_BindiegoJavascriptTextTransformer_JavascriptRuntime.Builder();
    }
     ...
     */
    @Nullable
    public String invoke(String data, String parameter) throws ScriptException, IOException, NoSuchMethodException {
      Invocable invocable = getInvocable();
      if (invocable == null) {
        throw new RuntimeException("No udf was loaded");
      }

      Object result = getInvocable().invokeFunction(functionName(), data, parameter());
  ...
  public abstract static class TransformTextViaJavascript
    ...
    public abstract @Nullable ValueProvider<String> parameter();
    ...
    public abstract static class Builder {
      ...
      public abstract Builder setParameter(@Nullable ValueProvider<String> parameter);

      public abstract TransformTextViaJavascript build();
    }

    public static Builder newBuilder() {
      return new AutoValue_BindiegoJavascriptTextTransformer_TransformTextViaJavascript.Builder();
    }
      ...
      return strings.apply(
          ParDo.of(
              new DoFn<String, String>() {
                ...
                @Setup
                public void setup() {
                  if (fileSystemPath() != null && functionName() != null && parameter() != null) {
                    javascriptRuntime =
                        getJavascriptRuntime(fileSystemPath().get(), functionName().get(), parameter().get());
                  }
                }
                ...
                public void processElement(ProcessContext c)
                  ...
                  if (javascriptRuntime != null) {
                    element = javascriptRuntime.invoke(element, parameter().get());
                  }
  ...
  /** Transforms Text Strings via a Javascript UDF. */
  @AutoValue
  public abstract static class BindiegoTransformTextViaJavascript
    ...
    public abstract TupleTag<String> successTag();
    ...
    public abstract static class Builder {
      ...
      public abstract Builder setSuccessTag(TupleTag<String> successTag);

      public abstract Builder setFailureTag(TupleTag<String> failureTag);

      public abstract BindiegoTransformTextViaJavascript build();
    }

    public static Builder newBuilder() {
      return new AutoValue_BindiegoJavascriptTextTransformer_BindiegoTransformTextViaJavascript.Builder();
    }

    @Override
    public PCollectionTuple expand(PCollection<String> strings) {
      return strings.apply(
          ParDo.of(
              new DoFn<String, String>() {
                private JavascriptRuntime javascriptRuntime;
  ...
  public abstract static class FailsafeJavascriptUdf<T>
    ...
    public static <T> Builder<T> newBuilder() {
      return new AutoValue_BindiegoJavascriptTextTransformer_FailsafeJavascriptUdf.Builder<>();
    }
    ...
    public abstract static class Builder<T> {
      ...
      public abstract Builder<T> setParameter(@Nullable ValueProvider<String> parameter);
          ...
          ParDo.of(
                  new DoFn<FailsafeElement<T, String>, FailsafeElement<T, String>>() {
                    ...
                    public void processElement(ProcessContext context) {
                      ...
                      try {
                        if (javascriptRuntime != null) {
                          payloadStr = javascriptRuntime.invoke(payloadStr, parameter().get());
                        }
  ...
  private static JavascriptRuntime getJavascriptRuntime(
      String fileSystemPath, String functionName, String parameter) {
